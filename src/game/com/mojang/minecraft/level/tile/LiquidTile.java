...
public class LiquidTile extends Tile {
	...
	public void tick(Level var1, int var2, int var3, int var4, Random var5) {
		...
		if (!ScuffedMinecraftServer.getInstance().liquidFlow) return;
		boolean var7 = false;
		var4 = var4;
		var3 = var3;
		var2 = var2;
		...
		} while(var6 && var8.liquid != Liquid.lava || ScuffedMinecraftServer.getInstance().lavaSponge);
		/* THE ABOVE LINE HAS BEEN MODIFIED FOR SCUFFEDSERVER */

		++var3;
		/* THE FOLLOWING LINE HAS BEEN MODIFIED FOR SCUFFEDSERVER */
		if(var8.liquid == Liquid.water || !var9 || ScuffedMinecraftServer.getInstance().lavaSponge) {
